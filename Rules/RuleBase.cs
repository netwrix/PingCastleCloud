...
namespace PingCastleCloud.Rules
{
    public abstract class RuleBase
    {
        ...
        protected virtual int? AnalyzeDataNew(HealthCheckCloudData healthcheckData)
        {
        ...
        public bool Analyze(HealthCheckCloudData healthcheckData)
        {
            bool hasTheRuleMatched = false;
            // PingCastle 2.5
            Points = 0;
            int? valueReturnedByAnalysis = AnalyzeDataNew(healthcheckData);
